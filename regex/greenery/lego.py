...
'''
from regex.greenery import fsm
...
class multiplier:
    ...
    @classmethod
    def match(cls, string, i = 0):
        # print("Jiarong: match multiplier")
        # {2,3} or {2,}
        try:
            j = static(string, i, "{")
